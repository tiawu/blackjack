...
while Player_Two_Card_Sum < 21
 ...
 elseif strcmpi(player_2nd_input,'No')
   fprintf('\n Here are dealer and your cards ')
   figure(1)
   subplot(3,1,2);imshow([BlueDeck{Dealer_hand1}]),title('Player Cards')
   subplot(3,1,1);imshow([BlueDeck{Dealer_twocard}]),title('Dealer Cards');
 else 
